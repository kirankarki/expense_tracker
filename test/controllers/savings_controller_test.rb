...
class SavingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create saving" do
    assert_difference('Saving.count') do
      post savings_url, params: { saving: { amount: @saving.amount, description: @saving.description, frequency_id: @saving.frequency_id, saved_date: @saving.saved_date, title: @saving.title, user_id: @saving.user_id } }
    end
  ...
  test "should update saving" do
    patch saving_url(@saving), params: { saving: { amount: @saving.amount, description: @saving.description, frequency_id: @saving.frequency_id, saved_date: @saving.saved_date, title: @saving.title, user_id: @saving.user_id } }
